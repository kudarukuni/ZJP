...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
          ...
          <img src="assets/img/web_logo.png" width="36rem">
        </div> &nbsp;&nbsp;&nbsp;
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - <?php echo $_SESSION['setting_name'] ?> | <a href="https://www.zetdc.co.zw" target="_blank">ZETDC Official Website</a></div></div>
        </footer>
